...
_test1:
	...
	# test 1
	test1_do(i1_name, o1_name)
	# test 2
	test1_do(i2_name, o2_name)
	# test 3
	test1_do(i3_name, o3_name)
...
.eqv	sa_size	4
	...
	lw	a0, of_name		# load output file name address
	coutT0				# print text
	coutT	(lit_nl)			# print new-line
